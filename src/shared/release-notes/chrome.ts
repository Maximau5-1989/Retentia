...
export const CHROME_RELEASE_NOTES: readonly ReleaseNotes[] = [
  {
    ...
    changes: [
      "Added browser-specific packaging while preserving Retentia's existing Chrome behavior.",
      "Kept Chrome's history-page context menu and service-worker background model unchanged.",
      "Added independent build validation for the Chrome and Firefox packages.",
    ],
  },
  {
    version: "2.1.0",
...
export const CURRENT_RELEASE_NOTES = CHROME_RELEASE_NOTES;
